...
public class ImageHelper {
    ...
    private static final int DEFAULT_BLUR_LEVEL =  4;
        ...
        try {
            ...
            Transformation blurTransformation = new Transformation() {
                ...
                public Bitmap transform(Bitmap source) {
                    Bitmap blurred = Blur.fastblur(context, source, DEFAULT_BLUR_LEVEL);
                    source.recycle();
                    return blurred;
                }
            ...
            Callback placeHolderCallback = new Callback() {
                @Override
            ...
            Picasso.with(context)
                    ...
                    .into(imageView, placeHolderCallback);
